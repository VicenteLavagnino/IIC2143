...
upload1=Cloudinary::Uploader.upload("https://res.cloudinary.com/db7ai9zpx/image/upload/v1698442749/hansolo_opbjup.jpg", 
                                    use_filename:true, 
...
puts "File size of the #{upload1['public_id']}.#{upload1['format']} " + 
"#{upload1['resource_type']}: #{upload1['bytes']/1024} KB"
...
puts "File size of the #{upload2['public_id']}.#{upload2['format']} " +
"#{upload2['resource_type']}: #{upload2['bytes']/1024} KB"
